        ...
        <div className="flex items-center space-x-6">
          <div className="relative">
            ...
            <input
              ...
              className="pl-10 pr-4 py-2.5 w-80 border border-slate-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-slate-50 focus:bg-white transition-colors"
            />
          </div>
        </div>
